...
public class SelendroidMasterPage extends MasterPage {

    public SelendroidMasterPage(AndroidDriver driver) {
        super(driver);
    }
    ...
    public DetailPage goDetailPageToAddCustomer() {
        ...
        WebElement addButton = mDriver.findElement(By.name("add"));
        addButton.click();
        DetailPage detailPage = new SelendroidDetailPage(mDriver);
