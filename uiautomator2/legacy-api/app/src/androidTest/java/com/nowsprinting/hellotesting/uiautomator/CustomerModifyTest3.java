...
import com.nowsprinting.hellotesting.uiautomator.page.MasterPageUnicodeSupport;
import com.nowsprinting.hellotesting.uiautomator.util.ShellCommands;

import android.support.test.uiautomator.UiAutomatorTestCase;

public class CustomerModifyTest3 extends UiAutomatorTestCase {
    ...
    private String addCustomers(int numberOfCustomers, String namePrefix) throws Exception {
        ...
        MasterPage page = new MasterPageUnicodeSupport();
