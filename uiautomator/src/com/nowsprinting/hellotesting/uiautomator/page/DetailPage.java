...
public class DetailPage {
    ...
    protected UiObject mNameTextField = new UiObject(new UiSelector().description("name textfield"));
    protected UiObject mMailTextField = new UiObject(new UiSelector().description("mail textfield"));
